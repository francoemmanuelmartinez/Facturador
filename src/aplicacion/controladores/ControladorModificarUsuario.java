...
public class ControladorModificarUsuario {
    ...
    public ControladorModificarUsuario(Usuario usuario,VentanaPrincipal ventanaPrincipal) {

        VistaModificarUsuarios vistaModificarUsuarios = new VistaModificarUsuarios(usuario, ventanaPrincipal);
